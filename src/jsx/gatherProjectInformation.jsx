...
(function() {
    ...
    function getLayerInfo(layer) {
        var layerInfo = {
            ...
            duration: [layer.inPoint, layer.outPoint],
            layer_size: {
                "width": layer.width,
                "height": layer.height
            },
        ...
        try {
            ...
            for (var i = 1; i <= numComps; i++) {
                ...
                if (compItem instanceof CompItem) {
                    var compInfo = getCompInfo(compItem);
    ...
    $._zag.gatherActivedCompInfo = function() {
        var compInfo = {};
        ...
        try {
            ...
            if (activeItem instanceof CompItem) {
                compInfo = getCompInfo(activeItem);
            }
            return compInfo;
        } catch (error) {
            return compInfo;
